...
import { CenterCallBtn, CloseBtn, LoginBtn, LoginInfo, MyInfoBox, MyPage, PhoneLogo, RegiBtn, SubBox, TopBar, TopBarText } from "../components/myPage/MyPageBar";
...
export default function MyPageBar({ activeMyPage, setActiveMyPage, login }: Props) {
