...
const ImageElement = /*#__PURE__*/(0, _react.forwardRef)((_param, forwardedRef) => {
  var {
    ...
    onError
      ...
      rest = _object_without_properties_loose._(_param, ["imgAttributes", "heightInt", "widthInt", "qualityInt", "className", "imgStyle", "blurStyle", "isLazy", "fetchPriority", "fill", "placeholder", "loading", "srcString", "config", "unoptimized", "loader", "onLoadRef", "onLoadingCompleteRef", "setBlurComplete", "setShowAltText", "onLoad", "onError"]);
...
const Image = /*#__PURE__*/(0, _react.forwardRef)((_param, forwardedRef) => {
  var {
    ...
    lazyRoot
      ...
      all = _object_without_properties_loose._(_param, ["src", "sizes", "unoptimized", "priority", "loading", "className", "quality", "width", "height", "fill", "style", "onLoad", "onLoadingComplete", "placeholder", "blurDataURL", "fetchPriority", "layout", "objectFit", "objectPosition", "lazyBoundary", "lazyRoot"]);
  ...
  /*#__PURE__*/
  _react.default.createElement(_head.default, null, /*#__PURE__*/_react.default.createElement("link", _extends._({
